...
export interface INeighborRepository{
    ...
    saveAvailabilty(id: string, availability: { date: Date; timeSlots: { startTime: number; endTime: number; note: "available" | "booked" }[]; }[]): Promise<Neighbor>;
    ...
    getavailableTimeslot(id: string): Promise<Availability[] | null>
