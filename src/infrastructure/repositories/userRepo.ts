...
//   async verifyGovtId(id: string, govtId: string): Promise<void> {
//     console.log("mongo rep",id,govtId)
//     await userModel.updateOne({ _id: id }, {
//       govtId,isVerified:true
//     })
//   }
...
//     const users = await userModel.find({ role: 'user' }, { password: 0 }).exec();
